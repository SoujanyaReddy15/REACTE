    ...
    <div className="p-6 max-w-4xl mx-auto bg-white shadow-lg rounded-2xl">
      ...
      <section className="mb-8">
        ...
        <div className="overflow-x-auto">
          <table className="w-full border border-gray-300 text-left text-sm text-black">
      ...
      <section className="mb-10">
        ...
        <div className="bg-gray-100 p-4 rounded-xl font-mono text-sm text-black">
          <p>npm install tailwindcss @tailwindcss/vite</p>
        </div>

        <h3 className="mt-4 font-semibold text-gray-700">Configure the Vite Plugin:</h3>
        <div className="bg-gray-100 p-4 rounded-xl font-mono text-sm text-black overflow-auto mt-2">
...
export default defineConfig({
  plugins: [react(), tailwindcss()],
        ...
        <div className="bg-gray-100 p-4 rounded-xl font-mono text-sm text-black mt-2">
